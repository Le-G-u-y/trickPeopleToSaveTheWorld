...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, de.tpsw.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, de.tpsw.repository.UserRepository.USERS_BY_EMAIL_CACHE);
            createCache(cm, de.tpsw.domain.User.class.getName());
